...
var notGenericUserRepo = new NotGenericUserRepository("./demo/shared/users.json");
notGenericUserRepo.getAsync()
    .then(function (users) {
    console.log("notGenericUserRepo() got: ", users);
}).catch((error) => {
...
page.msg("We have written almost all the same code again.  The only difference was the name"
    + " references for the particulars. User(s) / Talk(s). Using the any typewould allow the"
